...
image: "/src/content/assets/img/reverse21.jpg"
draft: false
lang: "eng"
...
<img src="/src/content/assets/img/switch1.jpg" alt="switch" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
<hr>
...
<img src="/src/content/assets/x32dbg2/7_1.png" alt="EAX = 2" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">

<p>
0 is subtracted from 2 in EAX. Of course, EAX still has 2. But the ZF flag is now 0, meaning the result is not zero:
</p>
<img src="/src/content/assets/x32dbg2/7_2.png" alt="After first SUB" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">

<p>
Then another SUB is performed. EAX finally becomes 0 and the ZF flag is set because the result became zero:
</p>
<img src="/src/content/assets/x32dbg2/7_3.png" alt="After second SUB" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
...
<img src="/src/content/assets/img/lotofcases.jpg" alt="lotofcases" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
<p>
...
<img src="/src/content/assets/x32dbg2/7_4.png" alt="EAX = 2" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
<p>
The input value of the function (2) is loaded into EAX:
</p>
<img src="/src/content/assets/x32dbg2/7_5.png" alt="EAX = 2" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">

<p>
Then the input value is checked: is it greater than 4? If not, the "default" jump is not taken:
</p>
<img src="/src/content/assets/x32dbg2/7_6.png" alt="CMP with 4" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">

<p>
Then we can view the jumptable by choosing Follow in Dump → Constant:
</p>
<img src="/src/content/assets/x32dbg2/7_7.png" alt="Jumptable in dump" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">

<p>
Now we see the jumptable in the data window. These are 5 32-bit values.
</p>
<img src="/src/content/assets/x32dbg2/7_8.png" alt="Jumptable in dump" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
<p>
...
<img src="/src/content/assets/x32dbg2/7_9.png" alt="At two case" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
