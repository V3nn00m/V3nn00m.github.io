...
image: "/src/content/assets/img/reversee24.jpg"
draft: false
lang: "eng"
...
<img src="/src/content/assets/img/muultiplication.jpg" alt="1.24.1 Multiplication" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
...
<img src="/src/content/assets/x32dbg2/shl1.png" alt="Shift left example" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
...
<img src="/src/content/assets/img/Division.jpg" alt="arithmetic optimizations" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
...
<img src="/src/content/assets/x32dbg2/shl2.png" alt="Shift right example" style="display:block; margin:20px auto; border-radius:12px; max-width:80%;">
