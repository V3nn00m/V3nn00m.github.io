...
export const siteConfig: SiteConfig = {
	...
	lang: "en-US", // 站点语言，影响日期格式和部分文本显示。请使用有效的语言代码，例如 'en-US'、'zh-CN'、'ja' 等。

	themeColor: {
		hue: 320, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	banner: {
		...
		homeText: {
			...
			title: "0xV3n0m", // 主页横幅主标题

			subtitle: [
				"Welcome To My Personal Blog",
				"have a nice day! 0xV3n0m",
			],
			typewriter: {
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				},
				{
					...
					external: true,
					url: "http://discord.com/users/696315444264566794",
				},
				{
					name: "Facebook",
...
export const profileConfig: ProfileConfig = {
	...
	name: "0xV3n0m",
	bio: "Bug Hunter | Reverse Engineer",
	typewriter: {
...
export const licenseConfig: LicenseConfig = {
	enable: true,
	name: "0xV3n0m's Personal Blog License",
	url: "https://linkedin.com/in/ahmed-allah-mohemd-53a60b232/",
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome To My Personal Blog", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api: "https://www.youtube.com/watch?v=z1mu9C1QqxU", // Meting API 地址
	id: "14164869977", // 歌单ID
