...
<p>
Pointers are often used to return values from functions <b style ="color: #0d6efd;">(remember the case of <code style = "color: chartreuse;"> scanf()</code> that we talked about before)</b>
</p>
<p>
